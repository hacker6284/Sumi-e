...
function OnPreCull()
{
	var projection : Matrix4x4 = GetComponent.<UnityEngine.Camera>().projectionMatrix;
	
	var m : Matrix4x4 = GetComponent.<UnityEngine.Camera>().worldToCameraMatrix;
	...
	GetComponent.<UnityEngine.Camera>().projectionMatrix = CalculateObliqueMatrix(projection, nearPlane);
}